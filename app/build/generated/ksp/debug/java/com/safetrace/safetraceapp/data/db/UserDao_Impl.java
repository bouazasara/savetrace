...
public final class UserDao_Impl implements UserDao {
  ...
  public UserDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUser = new EntityInsertionAdapter<User>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `user_data` (`id`,`name`,`firstName`,`age`,`phoneNumber`,`address`,`emergencyContactNumber`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindString(7, entity.getEmergencyContactNumber());
      }
    };
  }
  ...
  public Flow<User> getUser() {
    ...
    return CoroutinesRoom.createFlow(__db, false, new String[] {"user_data"}, new Callable<User>() {
      @Override
      @Nullable
      public User call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new User(_tmpId,_tmpName,_tmpFirstName,_tmpAge,_tmpPhoneNumber,_tmpAddress,_tmpEmergencyContactNumber);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Object getEmergencyContactNumber(final Continuation<? super String> $completion) {
    final String _sql = "SELECT emergencyContactNumber FROM user_data LIMIT 1";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
  ...
  public Object getUserCount(final Continuation<? super Integer> $completion) {
    final String _sql = "SELECT COUNT(*) FROM user_data";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
